...
void loop() {
  ...
  while (true) {
    ...
    if ( str1.equalsIgnoreCase(".bmp") )  // nếu như là .bmp thì vẽ ảnh từ vị trí 0-0
      bmpDraw(entry.name(), 0, 30);        // draw it

    //intext ra ngoài màn hình:
    //printText("Nguyen Van Anh", ST7735_WHITE, 22, 10, 1);

    //vạch kẻ: //tft.width(): chiều rộng
//    tft.drawFastHLine(0, 28,  35, ST7735_BLUE);
//    tft.drawFastHLine(38, 28,  52, ST7735_WHITE); //vạch trắng ở giữa
//    tft.drawFastHLine(93, 28,  35, ST7735_BLUE);

    entry.close();  // close the file

    if(count == 0){
        printText("Ngo Xuan Giang", ST7735_BLUE, 22, 10, 1);
        printText("GV: Pham Van Ha", ST7735_WHITE, 22, 10, 1);
    }

    if(count == 1){
        printText("GV: Pham Van Ha", ST7735_BLUE, 22, 10, 1);
        printText("Nguyen Van Anh", ST7735_WHITE, 22, 10, 1);
    }
    if(count == 2){
        printText("Nguyen Van Anh", ST7735_BLUE, 22, 10, 1);
        printText("Lam Tuan Cong", ST7735_WHITE, 22, 10, 1);
    }
    if(count == 3){
        printText("Lam Tuan Cong", ST7735_BLUE, 22, 10, 1);
        printText("Ngo Xuan Giang", ST7735_WHITE, 22, 10, 1);
    }
